...
def evaluate(args):
    ...
    print(f"Average reward over {args.episodes} episodes: {avg_reward / args.episodes:.2f}")

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--model-path", type=str, help="Path to trained .pt model", default="results_tk3_clip_Pong\\model_ep700.pt")
